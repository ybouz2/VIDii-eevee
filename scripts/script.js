...
document.querySelector("main section").onclick = function() {   
...
function wijzig(target) {
  ...
  var button = this
    ...
    if (button.id === "icestone") {
      // SOURCE VAN DE AFBEELDING IN HET MIDDEN EN AUDIO VERRANDEREN.  
      document.querySelector("main section img:first-of-type").src = eeveeLution[0];
      document.querySelector("audio").src = soundLution[0];
      
      // VERRANDER DE TEKST VAN DE H2 EN P ELEMENTEN.
      document.querySelector('main section article h2').innerHTML = "#471 Glaceon";
      document.querySelector('main section article p:first-of-type').innerHTML = "Ice";
      document.querySelector('main section article p:last-of-type').innerHTML = "Glaceon is a quadrupedal, mammalian Pokémon covered in light-blue fur that can be frozen into sharp quills. It has long, pointed ears, dark eyes, and a small nose. A teal crest with two dangling flaps adorns its head, resembling hair or headgear. Glaceon has two dark blue, rhombus-shaped markings on its back; the tip of its tail, feet, and flaps are the same shade of blue. </br> </br> By controlling its body temperature, the moisture in the air freezes, producing ice crystals or diamond dust surrounding it. It is capable of freezing its fur into sharp needle-like icicles, which it can fire at opponents or use as protection as it tackles at its prey. It can quickly drop its body temperature below −60 °C. Glaceon is rather popular in ski resorts due to its ability to create powdery snow. Those captivated by Glaceon's beautiful snowfall will be instantly frozen without realizing it.";
    ...
    //   document.querySelector(".eevee").style.background = '#DEF0F3';
    ...
    } else if (button.id === "leafstone") {
        // SOURCE VAN DE AFBEELDING IN HET MIDDEN VERRANDEREN.
        document.querySelector("main section img:first-of-type").src = eeveeLution[1];
        document.querySelector("audio").src = soundLution[1];

        // VERRANDER DE TEKST VAN DE H2 EN P ELEMENTEN.
        document.querySelector('main section article h2').innerHTML = "#470 Leafeon";
        document.querySelector('main section article p:first-of-type').innerHTML = "Grass";
        document.querySelector('main section article p:last-of-type').innerHTML = "Leafeon is a mammalian, quadrupedal Pokémon. Leafeon's ears and tail resemble tattered leaves. It has brown eyes and a small, brown nose. </br> </br> This Pokémon's cellular structure is similar to plants, which allows it to perform photosynthesis and purify the air around it by sleeping under the sunlight; it gets its energy in this way instead of eating. It is a pacifistic, quiet Pokémon, preferring not to fight, though it will sharpen its leafy tail for the occasions it needs to. The tail's sharpness is said to exceed that of a master's sword, sharp enough to cut down a large tree with one hit. Its aroma is similar to fresh grass in its youth; as it ages, this fragrance bears more of a resemblance to fallen leaves. The aroma is favored in Galar, where it is used to create a popular perfume. It lives in lush forests that have clean rivers."
        ...
        document.querySelector('main section article p:first-of-type').classList.add('type-border-color');
...
stones.forEach(function (i){
    ...
    i.addEventListener('mouseover' , () =>{
        ...
        document.querySelector("main section img:first-of-type").classList.add('eevee');
...
stones.forEach(function (i){
    ...
    i.addEventListener('mouseleave' , () =>{
        ...
        document.querySelector("main section img:first-of-type").classList.remove('eevee');
    }) 
})
